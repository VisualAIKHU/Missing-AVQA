...
class AVQA_dataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        ################ add noise ################ Kyuri
        # audio = audio + torch.rand(audio.shape)
        # visual_posi = visual_posi + torch.rand(visual_posi.shape)
        # visual_nega = visual_nega + torch.rand(visual_nega.shape)
        
        # audio = audio + np.random.rand(*audio.shape)
        # visual_posi = visual_posi + np.random.rand(*visual_posi.shape)
        # visual_nega = visual_nega + np.random.rand(*visual_nega.shape)
